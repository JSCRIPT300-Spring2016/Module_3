 ...
 * that method should take a single parameter
 * that represents the day to filter on
 * use the built-in filter() method to return
 * all trucks that have the day in their
 * schedule
 */
...
module.exports = {
  ...
  filterByDay: function (day) {
    ...
    for (var i = 0; i < foodTrucks.length; i++) {
      testArray = foodTrucks[i].schedule;
